    ...
    >
      <div
        className={`fixed z-50 ${
          collapsed ? "w-16" : "w-80"
        } bg-white border border-gray-200 rounded-lg shadow-lg h-auto max-h-[90vh] overflow-y-auto transition-width duration-200`}
      >
        {/* Drag handle */}
        ...
        {!collapsed ? (
          ...
          <div className="flex flex-col items-center p-2 space-y-4">
            ...
            <Button
              variant="ghost"
              size="sm"
              className="rounded-full w-10 h-10 flex items-center justify-center text-red-600"
              onClick={clearCache}
            >
